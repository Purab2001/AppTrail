...
export default function PrimaryButton({ text, to = "#", onClick, variant = "solid", className = "" }) {
  const base =
  ...
  const content = (
    <>
      <span>{text}</span>
      <span className="inline-flex items-center justify-center w-7 h-7 rounded-full bg-white/15 group-hover:bg-white/15 transition-transform duration-300 group-hover:rotate-45">
